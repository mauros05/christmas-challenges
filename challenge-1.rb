...
def correct_caracters(array)
  new_array = [array.first, array.last]
end
...
def split_string(string)
  ...
  characters.each do |character|
    integer_array << character if character =~ /\d/
  end
  correct_numbers = correct_caracters(integer_array)
  correct_numbers.join
end

def generate_array_numbers(variables)
  integers = []
  new_array_variables = split_variable(variables)
  new_array_variables.each do |variable|
    integers << split_string(variable)
  end
  integers
end

def convert_to_numbers_and_sum(variable)
  array = generate_array_numbers(variable)
  array.map(&:to_i).inject(0,:+)
end

variable = "fouronevhnrz44
eightg1
...
p convert_to_numbers_and_sum(variable)
